                    ...
                    <div style={{ flexDirection: "column"}}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto3}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto3}>
                                        <input {...getInputProps()} name="foto_Foto3" />
                                        {previewFoto3 ? (
                                            isPreviewFoto3 ? (
                                                <img className="preview-image" src={previewFoto3} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
                    ...
                    <div style={{ flexDirection: "column" }}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto4}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto4}>
                                        <input {...getInputProps()} name="foto_Foto4" />
                                        {previewFoto4 ? (
                                            isPreviewFoto4 ? (
                                                <img className="preview-image" src={previewFoto4} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
                    ...
                    <div style={{ flexDirection: "column"}}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto5}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto5}>
                                        <input {...getInputProps()} name="foto_Foto5" />
                                        {previewFoto5 ? (
                                            isPreviewFoto5 ? (
                                                <img className="preview-image" src={previewFoto5} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
                    ...
                    <div style={{ flexDirection: "column" }}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto6}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto6}>
                                        <input {...getInputProps()} name="foto_Foto6" />
                                        {previewFoto6 ? (
                                            isPreviewFoto6 ? (
                                                <img className="preview-image" src={previewFoto6} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
                    ...
                    <div style={{ flexDirection: "column"}}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto7}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto7}>
                                        <input {...getInputProps()} name="foto_Foto7" />
                                        {previewFoto7 ? (
                                            isPreviewFoto7 ? (
                                                <img className="preview-image" src={previewFoto7} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
                    ...
                    <div style={{ flexDirection: "column" }}>
                        <UploadFile>
                            <Dropzone onDrop={onDropFoto8}>
                                {({ getRootProps, getInputProps }) => (
                                    <FileViewStyle {...getRootProps({ className: "drop-zone" })} ref={dropRefFoto8}>
                                        <input {...getInputProps()} name="foto_Foto8" />
                                        {previewFoto8 ? (
                                            isPreviewFoto8 ? (
                                                <img className="preview-image" src={previewFoto8} alt="Preview" width="100%" height="100%" />
                                            ) : (
                                                <TitleProfileVendor>No preview available for this file</TitleProfileVendor>
                                            )
                                        ) : (
